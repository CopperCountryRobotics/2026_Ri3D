...
public class SwerveModule implements IDashboardProvider {
    ...
    public void resetEncoder() {
        ...
        this.turn.getEncoder().setPosition(this.encoder.getRotation().getRotations());
    }
    ...
    public void setDesiredState(SwerveModuleState desiredState) {
        ...
        this.drive.setVoltage(MathUtil.clamp((driveVoltage * 6), -7, 7));
        this.turn.setVoltage(MathUtil.clamp((turnVoltage * 5), -5, 5));
    }
